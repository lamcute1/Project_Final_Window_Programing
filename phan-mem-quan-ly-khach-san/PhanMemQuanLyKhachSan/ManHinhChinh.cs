...
namespace PhanMemQuanLyKhachSan
{
    public partial class frmManHinhChinh : Form
    {
        ...
        public void SetBookingRoom()
        {
            ...
            {
                DateTime dt = DateTime.Parse(hd1.NgayHD);
            ...
            {
                DateTime dt = DateTime.Parse(hd2.NgayHD);
                if (dt.Date >= DateTime.Now)
                {
            ...
            {
                DateTime dt = DateTime.Parse(hd3.NgayHD);
                if (dt.Date >= DateTime.Now)
                {
            ...
            {
                DateTime dt = DateTime.Parse(hd4.NgayHD);
                if (dt.Date >= DateTime.Now)
                {
            ...
            {
                DateTime dt = DateTime.Parse(hd5.NgayHD);
                if (dt.Date >= DateTime.Now)
                {
            ...
            {
                DateTime dt = DateTime.Parse(hd6.NgayHD);
                if (dt.Date >= DateTime.Now)
                {
            ...
            {
                DateTime dt = DateTime.Parse(hd7.NgayHD);
                if (dt.Date >= DateTime.Now)
                {
            ...
            {
                DateTime dt = DateTime.Parse(hd8.NgayHD);
                if (dt.Date >= DateTime.Now)
                {
