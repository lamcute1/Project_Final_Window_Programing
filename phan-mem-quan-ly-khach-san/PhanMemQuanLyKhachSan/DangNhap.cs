...
namespace PhanMemQuanLyKhachSan
{
    public partial class frmDangNhap : Form
    {
        ...
        private void BtnDangNhap_Click(object sender, EventArgs e)
        {
            ...
            if (check.Count > 0)
            {
                ...
                {
                    MessageBox.Show("Đăng nhập thành công!", "Notify", MessageBoxButtons.OKCancel,
    MessageBoxIcon.Information);
                ...
                {
                    MessageBox.Show("Mật khẩu không đúng!", "Error", MessageBoxButtons.OKCancel,
    ...
    MessageBoxIcon.Error);
        ...
        {
            LayLaiMatKhau form = new LayLaiMatKhau();
            form.Show();
        }
